...
#docker build -t safehaven_ds:stage4 -f Dockerfile.addjulia . 2>&1 | tee -a build.log
#docker build -t safehaven_ds:stage5 -f Dockerfile.addtensorflow . 2>&1 | tee -a build.log
